export const portfolioSystems = [
  {
    ...
    links: [
      {
        label: "Open site",
        url: "https://network.shubodaya.dev/"
      }
    ]
  },
  {
    ...
    links: [
      {
        label: "Open site",
        url: "https://security.shubodaya.dev/"
      }
    ]
  },
  {
    slug: "portfolio-pentest",
    title: "Pentesting Portfolio",
    year: "2026",
    category: "Portfolio Systems",
    ...
    outcomes: [
      ...
      "Stronger positioning for pentest and adversary-simulation work"
    ],
    image: "/assets/projects/site-pentest-browser.png",
    alt: "Pentesting portfolio homepage with white-hat operator visual and offensive-security framing.",
    featured: false,
    links: [
      {
        label: "Open site",
        url: "https://portfolio-pen.pages.dev/"
      }
    ]
  },
  {
    ...
    links: [
      {
        label: "Open site",
        url: "https://infotech.shubodaya.dev/"
      }
    ]
  },
  {
    ...
    links: [
      {
        label: "Open blog",
        url: "https://blog.shubodaya.dev/"
      }
    ]
  },
  {
    slug: "portfolio-3d",
    title: "3D Security Portfolio",
    year: "2026",
    category: "Portfolio Systems",
    type: "Interactive portfolio experiment",
    summary:
      "A 3D-first portfolio experiment that explores how immersive visuals can present technical work without losing the underlying story.",
    proof:
      "Shows comfort with visual experimentation, motion-heavy interfaces, and a more cinematic presentation style.",
    stack: ["React", "Three.js", "3D scene work"],
    outcomes: [
      "Immersive hero and scene-driven layout",
      "Security branding with stronger visual personality",
      "A creative visual layer alongside the more formal portfolio versions"
    ],
    image: "/assets/projects/site-3d-browser.png",
    alt: "3D security portfolio homepage with shield visual and matrix-style background.",
    featured: false,
    links: [
      {
        label: "Open site",
        url: "https://shubodaya.github.io/portfolio-sec-3d/"
      }
    ]
  }
];
